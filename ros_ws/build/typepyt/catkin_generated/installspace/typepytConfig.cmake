...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'typepyt' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/elecia/Ty/TyPEpyt/ros_ws/install/${idir}'.  Ask the maintainer 'Elecia White <elecia@mailinator.com>, Elecia White <elecia@mailinator.com>' to fix it.")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/elecia/Ty/TyPEpyt/ros_ws/install/lib;/opt/ros/kinetic/lib)
