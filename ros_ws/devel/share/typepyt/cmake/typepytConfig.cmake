...
if("TRUE" STREQUAL "TRUE")
  set(typepyt_SOURCE_PREFIX /home/elecia/Ty/TyPEpyt/ros_ws/src/typepyt)
  set(typepyt_DEVEL_PREFIX /home/elecia/Ty/TyPEpyt/ros_ws/devel)
  set(typepyt_INSTALL_PREFIX "")
  set(typepyt_PREFIX ${typepyt_DEVEL_PREFIX})
else()
  set(typepyt_SOURCE_PREFIX "")
  set(typepyt_DEVEL_PREFIX "")
  set(typepyt_INSTALL_PREFIX /home/elecia/Ty/TyPEpyt/ros_ws/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'typepyt' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/elecia/Ty/TyPEpyt/ros_ws/src/typepyt/${idir}'.  Ask the maintainer 'Elecia White <elecia@mailinator.com>, Elecia White <elecia@mailinator.com>' to fix it.")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/elecia/Ty/TyPEpyt/ros_ws/devel/lib;/opt/ros/kinetic/lib)
